...
console.log("NUMBERS + STRING & VICE VERSA")
console.log("Keerthi" + 16);
console.log("Keerthi" + 16 + 4);
console.log(16 + "Keerthi")
console.log(16 + 4 + "Keerthi")

//Anything + Undefined = NaN (except String + undefined or Vice vers)
...
// NEUMRICAL STRING + NUMBER ARITHMETIC OPERATION
console.log("NUMBERICAL STRING + NUMBER : ARITHMETIC OPERATIONS")
console.log("2" + 2)
console.log("2" - 2)
console.log("2" * 2)
console.log("2" / 2)
