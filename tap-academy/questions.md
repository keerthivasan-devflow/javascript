...
8. What is string pool and string interning?
9. Benefits of string interning 
    String comparison becomes faster, There will be only one of string will be there in string pool.(Memory Optimization)
